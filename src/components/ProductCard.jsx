      ...
      <div className="w-full max-w-[300px] rounded-md overflow-hidden group font-sans bg-[#F5F5F5]">
        <div className="relative w-full h-[250px] flex items-center justify-center p-4 rounded-t-md group overflow-hidden">
          <div className="absolute top-3 right-3 flex flex-col space-y-2">
            <p className="bg-white p-2 rounded-full shadow-sm hover:bg-gray-100 transition-colors cursor-pointer">
          ...
          <button className="flex items-center justify-center py-2 px-4 w-full text-white bg-black cursor-pointer absolute bottom-0 left-0 z-10 transition-all invisible group-hover:visible">
            Add To Cart
          </button>
        </div>
