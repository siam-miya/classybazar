...
const SubBanner = ({ title, pageName }) => {
  return (
    <section 
      ...
      className="w-full max-h-[40vh] md:max-h-[200px] bg-cover bg-center bg-no-repeat relative flex items-center justify-center border-b border-gray-100 font-poppins"
    >
